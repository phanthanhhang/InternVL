...
def get_groundtruth(image_path):
    path1 = '/data1/hang/Stellantis/InternVL/notebooks/vdn_chat_train_fieldtext_ocr.jsonl'
    path2 = '/data1/hang/Stellantis/InternVL/notebooks/vdn_chat_valid_fieldtext_ocr.jsonl'
    ...
    for item in data1:
        if item['image'] == image_path:
            ...
            return human_question, groundtruth
    for item in data2:
        if item['image'] == image_path:
            print('validdata groundtruth')
            conversations = item['conversations']
            human_question = None
            groundtruth = None
            for conv in conversations:
...
def main():
    ...
    #                     }
    #     """, help='Question about the image (optional, for single image mode)')
    parser.add_argument('--checkpoint', type=str, default = "/data1/hang/Stellantis/InternVL/internvl_chat/work_dirs/internvl_chat_v3/vdn_fieldtext_internvl3_1b_dynamic_res_2nd_finetune_full_less_patch_more_resolution")
    ...
    gt_prompt, gt_answer = get_groundtruth(image_path)
    args.question = gt_prompt   
    ...
    print('='*100)
    print(get_groundtruth(image_path)[1])
    print('='*100)
    print(answer)
